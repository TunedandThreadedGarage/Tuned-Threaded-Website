...
export const NOTIFICATION_PREF_EVENTS = [
  ...
  { key: "messages", label: "Messages", hint: "Direct messages and message requests" },
  { key: "journal", label: "Journal", hint: "Journal likes and comments" },
  { key: "gallery", label: "Gallery", hint: "Gallery interactions on your photos" },
